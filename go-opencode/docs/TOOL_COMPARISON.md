...
| Result metadata | Returns unified diff text plus structured addition/deletion counts and LSP diagnostics. | Returns replacement count and before/after snapshots only. | Go omits diff payloads and diagnostics, reducing observability of edits.【F:packages/opencode/src/tool/edit.ts†L109-L172】【F:go-opencode/internal/tool/edit.go†L127-L136】
...
| Aspect | TypeScript | Go | Notes |
| --- | --- | --- | --- |
| Workspace/permissions | Resolves relative paths, enforces workspace bounds, and asks before overwriting/creating based on agent permissions. | Writes directly after ensuring parent dirs; no permission gates or workspace enforcement. | Go bypasses safety prompts and external-directory checks.【F:packages/opencode/src/tool/write.ts†L20-L70】【F:go-opencode/internal/tool/write.go†L59-L94】
...
| Post-write metadata | Returns LSP diagnostics and file metadata; triggers bus event and file-time tracking. | Returns byte count; publishes file-edited event. | Go lacks diagnostics feedback and file-time updates.【F:packages/opencode/src/tool/write.ts†L71-L97】【F:go-opencode/internal/tool/write.go†L71-L94】
...
2. **Safety and permissions**: TypeScript wraps read/edit/write/bash with workspace-boundary enforcement, permission prompts, and LSP/file-time integration; Go generally omits these checks, making writes/reads/edits less constrained.【F:packages/opencode/src/tool/read.ts†L26-L151】【F:packages/opencode/src/tool/edit.ts†L44-L172】【F:packages/opencode/src/tool/write.ts†L20-L97】【F:packages/opencode/src/tool/bash.ts†L34-L150】【F:go-opencode/internal/tool/read.go†L16-L146】【F:go-opencode/internal/tool/edit.go†L72-L199】【F:go-opencode/internal/tool/write.go†L59-L94】【F:go-opencode/internal/tool/bash.go†L15-L164】
3. **Result richness**: TypeScript tools emit diffs, diagnostics, and structured metadata (e.g., additions/deletions, preview snippets), while Go responses are simpler and omit LSP-driven feedback and diff artifacts.【F:packages/opencode/src/tool/read.ts†L123-L151】【F:packages/opencode/src/tool/edit.ts†L109-L172】【F:packages/opencode/src/tool/write.ts†L71-L97】【F:go-opencode/internal/tool/read.go†L117-L146】【F:go-opencode/internal/tool/edit.go†L127-L198】【F:go-opencode/internal/tool/write.go†L71-L94】
