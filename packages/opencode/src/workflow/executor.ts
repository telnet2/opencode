...
export namespace WorkflowExecutor {
  ...
  export const Event = {
    Started: BusEvent.define("workflow.started", WorkflowEventPayloads.Started),
    StepStarted: BusEvent.define("workflow.step.started", WorkflowEventPayloads.StepStarted),
    StepCompleted: BusEvent.define("workflow.step.completed", WorkflowEventPayloads.StepCompleted),
    StepFailed: BusEvent.define("workflow.step.failed", WorkflowEventPayloads.StepFailed),
    Paused: BusEvent.define("workflow.paused", WorkflowEventPayloads.Paused),
    Resumed: BusEvent.define("workflow.resumed", WorkflowEventPayloads.Resumed),
    Completed: BusEvent.define("workflow.completed", WorkflowEventPayloads.Completed),
    Failed: BusEvent.define("workflow.failed", WorkflowEventPayloads.Failed),
    Cancelled: BusEvent.define("workflow.cancelled", WorkflowEventPayloads.Cancelled),
  }
